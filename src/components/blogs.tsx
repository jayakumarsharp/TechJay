...
export function BlogCard({ post }: { post: PostMetadata }) {
  return (
    <Link key={post.slug + post.title} href='https://www.linkedin.com/pulse/various-asset-classes-wealth-creation-jayakumar-thangavel-n2zrf/?trackingId=7b3oIT3LTkS4pg6zFJLXyQ%3D%3D'>
